...
const defaultTasks: Task[] = [
  {
    ...
    studentsCount: 240,
    description:
      "Learn how to build modern web applications using React. This comprehensive course covers components, hooks, state management, routing, and best practices for building scalable React applications.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 195,
    description:
      "Master mobile UI design principles and create stunning mobile interfaces. Learn about mobile-first design, touch interactions, responsive layouts, and platform-specific design guidelines.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 165,
    description:
      "Create high-converting landing pages that drive results. Learn about conversion optimization, A/B testing, persuasive copywriting, and design techniques that turn visitors into customers.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 205,
    description:
      "Build robust REST APIs from scratch. Learn about HTTP methods, status codes, request/response handling, authentication, error handling, and API documentation best practices.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 140,
    description:
      "Learn the fundamentals of wireframing and information architecture. This course teaches you how to plan and structure your designs before diving into visual details, ensuring better user experiences.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 185,
    description:
      "Master database design and schema creation. Learn about normalization, relationships, indexing, query optimization, and best practices for designing efficient and scalable databases.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 155,
    description:
      "Create cohesive icon sets that enhance your design projects. Learn about icon design principles, consistency, scalability, and how to create icons that work across different platforms and sizes.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 230,
    description:
      "Implement secure authentication systems for your applications. Learn about password hashing, JWT tokens, OAuth, session management, and security best practices for protecting user data.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 110,
    description:
      "Learn how to write effective user stories that drive product development. This course covers story structure, acceptance criteria, prioritization, and how to work with development teams.",
    assessmentPoints: [
