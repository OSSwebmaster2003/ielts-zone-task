...
const defaultTasks: Task[] = [
  ...
  },
  {
    ...
    studentsCount: 150,
    description:
      "Learn how to build modern, responsive websites from scratch. This course covers HTML, CSS, JavaScript fundamentals, and best practices for creating beautiful and functional web applications.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 180,
    description:
      "Discover the art and science of color in design. Learn how to create harmonious color palettes, understand color psychology, and apply color theory to your design projects effectively.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 120,
    description:
      "Learn how to develop effective business strategies for web projects. This course covers market analysis, user research, competitive analysis, and strategic planning for digital products.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 220,
    description:
      "Master the principles of user interface design. Learn how to create intuitive, accessible, and visually appealing interfaces that enhance user experience and drive engagement.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 190,
    description:
      "Build a complete e-commerce platform from scratch. Learn about shopping carts, payment integration, product management, inventory systems, and order processing.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 160,
    description:
      "Learn how to create compelling brand identities that resonate with your target audience. This course covers logo design, typography, brand guidelines, and visual identity systems.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 210,
    description:
      "Master backend development and API creation. Learn about RESTful APIs, database design, authentication, security, and server-side programming best practices.",
    assessmentPoints: [
  ...
  },
  {
    ...
    studentsCount: 175,
    description:
      "Learn how to design effective dashboards that present complex data in an intuitive way. This course covers data visualization, information architecture, and dashboard best practices.",
    assessmentPoints: [
